...
String getAlertText(int id, bool firstLine) {
  switch(id) {
    ...
    case 13: return firstLine ? "Received" : "a mandate";
    case 14: return firstLine ? "Low brake" : "pressure!";
    case 15: return firstLine ? "Go to service" : "station!";
    //ALERT
    case 21: return firstLine ? "BRAKES LOCKED!" : "";
    case 22: return firstLine ? "Rest time" : "exceeded!";
    case 23: return firstLine ? "Release" : "the handbrake!";
    default: return "";
  }
}
